...
def result(request):   
    # if lat and lon:
    #     url = 'https://api.openweathermap.org/data/2.5/weather?lat={}&lon={}&units=metric&appid=45b01a7f6a9893cc9370a6fd91f105fb'.format(lat, lon)
    # else:
    #     city = request.GET.get('city', 'New York')
    #     url = 'https://api.openweathermap.org/data/2.5/weather?q={}&units=metric&appid=45b01a7f6a9893cc9370a6fd91f105fb'.format(city)
